...
test("buildPostBountyArgs serializes a USDC GitHub bounty for AIJobsCore", () => {
  const args = buildPostBountyArgs({
    token: USDC,
    tokenDecimals: 6,
    repoUrl: "https://github.com/AtlasNexusTech/aijobs",
    instructionUrl: "https://github.com/AtlasNexusTech/aijobs/issues/42",
  ...
  assert.equal(args[2], "https://github.com/AtlasNexusTech/aijobs");
  assert.equal(args[3], "https://github.com/AtlasNexusTech/aijobs/issues/42");
