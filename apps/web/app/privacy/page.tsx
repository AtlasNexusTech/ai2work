...
export const metadata: Metadata = { title: "Privacy", description: "How AI.JOBS handles wallet, GitHub and technical data." };

export default function PrivacyPage() {
  return <TrustPage title="Privacy" intro="AI.JOBS minimizes off-chain data, but using a blockchain and external wallet or GitHub services is not anonymous." sections={[
    ...
    { title: "Wallet and GitHub providers", body: <p>Wallet connections and GitHub links are handled with third-party infrastructure. Their privacy policies apply to data they process. AI.JOBS never needs your seed phrase or private key.</p> },
