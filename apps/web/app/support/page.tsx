...
export const metadata: Metadata = { title: "Support", description: "Support and incident-reporting channels for AI2Work." };
...
export default function SupportPage() {
  return <TrustPage title="Support" intro="Use the public issue tracker for reproducible product bugs and email for account, privacy or security-sensitive questions." sections={[
    ...
    { title: "Public bug reports", body: <p><Link className="text-primary hover:underline" href="https://github.com/AtlasNexusTech/ai2work/issues">Open an issue on GitHub</Link> for reproducible non-sensitive defects.</p> },
